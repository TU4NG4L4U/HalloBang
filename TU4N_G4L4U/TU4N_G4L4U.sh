...
echo -e  "Tools    : Install TU4N_G4L4U $white         " |lolcat
echo -e  "Creadby  : TU4N G4L4U Tamvans $white   " |lolcat
echo -e  "Contact  : 081514074360 $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : TU4N_G4L4U" | lolcat
exit
;;
